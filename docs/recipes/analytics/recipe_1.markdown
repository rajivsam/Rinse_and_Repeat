...
See the ITSM example in the repository, for example, the implementation of this recipe for a reference implementation for this recipe. This implementation follows the template discussed in the <a href="{{ '/about/' }}">overview </a> section. Specifically:
